...
Follow [the fitness integration design](docs/JEV-FITNESS.md) for the proposed tracking architecture and [the A2A guide](docs/A2A.md) for the implemented negotiation boundary. Jev fitness inference is not implemented yet. Do not describe documentation or fixtures as a live integration.
